...
from views.api.user import UserManageAPIHandler, MerchantCoopedHotelAPIHandler
...
from views.api.submit_order import SubmitOrderAPIHandler, CancelOrderAPIHander, UpdateOrderPayStatusApiHander
...
from views.api.order import OrderWaitingAPIHandler, OrderTodayBookListAPIHandler, OrderTodayCheckinListAPIHandler, OrderUserConfirmAPIHandler, OrderUserCancelAPIHandler, OrderSearchAPIHandler, \
        OrderSwitchSearchAPIHandler, OrderSwitchConfirmAPIHandler, OrderExportExceAPiHandler
...
handlers = [
        ...
        (r"/api/userManage/hotels/?", MerchantCoopedHotelAPIHandler),
        ...
        (r"/api/order/search/export/?", OrderExportExceAPiHandler),
        (r"/api/inventory/complete/?", InventoryCompleteAPIHandler),
        (r"/api/order/search/switch/?", OrderSwitchSearchAPIHandler),
        (r"/api/order/confirm/switch/?", OrderSwitchConfirmAPIHandler),
        ...
        (r"/api/inner/ordersys/order/change/pay/?", UpdateOrderPayStatusApiHander),
