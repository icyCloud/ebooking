...
class HotelCoopedAPIHandler(BtwBaseHandler):
    ...
    def get(self):
        ...
        hotels, total = yield self.get_cooped_hotels(self.current_user.merchant_id, start, limit, name, city_id,
                                                     district_id, star, is_online, self.current_user.hotel_id)
    ...
    @gen.coroutine
    def get_cooped_hotels(self, merchant_id, start, limit, name, city_id, district_id, star, is_online, hotel_id=None):
        cooped_base_hotels = self.get_cooped_base_hotels(merchant_id, is_online, hotel_id)
    ...
    def fetch_hotels(self, name, city_id, district_id, star, within_ids, start, limit):
        params = {'name': url_escape(name) if name else None, 'city_id': city_id, 'district_id': district_id,
                  'star': star, 'start': start, 'limit': limit}
